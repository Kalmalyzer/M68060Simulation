...
static const InstructionTestCase immediateTests[] =
{
	...
	{ "ADDI.W #$1234,$1234(A1,D2.L)", 4, { 0x0671, 0x1234, 0x2920, 0x1234, }, 3, {
																														{ "LOADI",					{ 0x1234, 0x0000, },	ExecutionResource_None,				ExecutionResource_None,				0,	AguIndexSize_None,	AguDisplacementSize_None,	AguOperation_None,					ExecutionResource_None,				false,	ExecutionResource_uOpWord0,			ExecutionResource_None,				OperationSize_None,	IeeOperation_ForwardIeeA,	ExecutionResource_ImmediateTemp,	false,	Pairability_pOEP_Only,		0,	},
