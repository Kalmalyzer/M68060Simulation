...
static OpWordClassInfo s_opWordClassInformation[] =
{
	...
	{ 0, SizeEncoding_Byte, EAEncoding_DefaultEALocation, EAModeMask_Data, EAEncoding_MoveDestinationEALocation, EAModeMask_DataAlterable, DecodeOperand_DefaultEALocation, DecodeOperand_MoveDestinationEALocation, DestinationOperandAccessType_WriteOnly, }, // OpWordClass_Move_B,
	{ 0, SizeEncoding_Word, EAEncoding_DefaultEALocation, EAModeMask_All, EAEncoding_MoveDestinationEALocation, EAModeMask_Alterable, DecodeOperand_DefaultEALocation, DecodeOperand_MoveDestinationEALocation, DestinationOperandAccessType_WriteOnly, }, // OpWordClass_Move_W,
	{ 0, SizeEncoding_Long, EAEncoding_DefaultEALocation, EAModeMask_All, EAEncoding_MoveDestinationEALocation, EAModeMask_Alterable, DecodeOperand_DefaultEALocation, DecodeOperand_MoveDestinationEALocation, DestinationOperandAccessType_WriteOnly, }, // OpWordClass_Move_L,
